        ...
        <div class="view-artical-content-wrapper">
            <div class="view-artical-content">
                <div class="view-artical-left-section">
                    ...
                    <div class="view-artical-heading">
                        <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, nam ex animi magnam
                            libero
                            id!
                        </h1>
                    </div>
            ...
            <div class="view-artical-bottom-content">
                <div class="view-artical-bottom-content-left">
                    <span class="doi" style="display: inline; font-size: 8px;">Doi:</span> <a style="text-decoration: none; font-size: 12px; color:white;" href="#">https://chatgpt.com/</a>
                    <span>Under a creative Commons <span style="display: inline; color: var(--blue-color);">license</span> </span>
                </div>
